    ...
    <section className="py-12 border-b border-border">
      <div className="container text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-muted-foreground text-sm max-w-md mx-auto">Visit us at our Kacharakanahalli branch in Bangalore.</p>
        </motion.div>
      </div>
    </section>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <div className="bg-card rounded-xl p-6 md:p-8 border border-border">
            <div className="flex items-start gap-4 mb-5">
              <img src={shopExterior} alt="Cutie 6 Pet Kacharakanahalli" className="w-16 h-16 rounded-lg object-cover shrink-0" loading="lazy" />
              <div>
                ...
                <span className="flex items-center gap-1 text-sm font-medium text-amber mt-0.5">
                  <Star className="w-3.5 h-3.5 fill-current" />{location.rating} ({location.reviews} reviews)
                </span>
              </div>
            </div>

            <div className="space-y-2 text-sm text-muted-foreground mb-6">
              <p className="flex items-start gap-2"><MapPin className="w-4 h-4 text-primary shrink-0 mt-0.5" />{location.address}</p>
              <p className="flex items-center gap-2"><Phone className="w-4 h-4 text-primary" />{location.phone}</p>
              <p className="flex items-center gap-2"><Mail className="w-4 h-4 text-primary" />{location.email}</p>
              <p className="flex items-center gap-2"><Clock className="w-4 h-4 text-primary" />{location.hours}</p>
            </div>
